...
//
//	mockgen -package mock_github -destination internal/providers/github/mock/github.go -source pkg/providers/v1/providers.go GitHubLite
//
...
// MockGithubLite is a mock of GithubLite interface.
type MockGithubLite struct {
	ctrl     *gomock.Controller
	recorder *MockGithubLiteMockRecorder
}

// MockGithubLiteMockRecorder is the mock recorder for MockGithubLite.
type MockGithubLiteMockRecorder struct {
	mock *MockGithubLite
}

// NewMockGithubLite creates a new mock instance.
func NewMockGithubLite(ctrl *gomock.Controller) *MockGithubLite {
	mock := &MockGithubLite{ctrl: ctrl}
	mock.recorder = &MockGithubLiteMockRecorder{mock}
	return mock
}

// EXPECT returns an object that allows the caller to indicate expected use.
func (m *MockGithubLite) EXPECT() *MockGithubLiteMockRecorder {
	return m.recorder
}

// GetLoginByToken mocks base method.
func (m *MockGithubLite) GetLoginByToken(ctx context.Context, token *oauth2.Token) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetLoginByToken", ctx, token)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetLoginByToken indicates an expected call of GetLoginByToken.
func (mr *MockGithubLiteMockRecorder) GetLoginByToken(ctx, token any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetLoginByToken", reflect.TypeOf((*MockGithubLite)(nil).GetLoginByToken), ctx, token)
}

// IsMemberInOrganization mocks base method.
func (m *MockGithubLite) IsMemberInOrganization(ctx context.Context, token *oauth2.Token, org, user string) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IsMemberInOrganization", ctx, token, org, user)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// IsMemberInOrganization indicates an expected call of IsMemberInOrganization.
func (mr *MockGithubLiteMockRecorder) IsMemberInOrganization(ctx, token, org, user any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "IsMemberInOrganization", reflect.TypeOf((*MockGithubLite)(nil).IsMemberInOrganization), ctx, token, org, user)
}
